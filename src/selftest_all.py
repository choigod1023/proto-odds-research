...
TESTS = [
    ...
    ("player_info.py", "선수정보 (팀 별칭 · 날짜 경기키 · 이닝 · 상세 선발)"),
    ("combo.py", "조합 산술 (규정 · 다리 추가는 손해 · 대수의 법칙)"),
    ("today_combo.py", "오늘의 조합 (서로 다른 경기 · 금지 배당대 · 음수 EV)"),
    ("lineup_soccer.py", "축구 라인업 (선발 11명 · 교체 0~11 · 중복 없음)"),
    ("soccer_process2.py", "과정지표 결합 (팀 이름 정규화 · 시장확률 범위)"),
