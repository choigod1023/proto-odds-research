...
export function predictionFor(game, recommended = null) {
  ...
  const basisLabel = decision.recommendationPriority === "reversal" ? "전환 픽 · " : "";
  let headline;
